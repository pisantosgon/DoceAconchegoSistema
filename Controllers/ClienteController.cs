...
namespace Doceaconchego.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ClienteId,NomeCliente,EmailCliente,SenhaCliente,FoneCliente,CpfCliente,SexoCliente,SexoBebe")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClienteId,NomeCliente,EmailCliente,SenhaCliente,FoneCliente,CpfCliente,SexoCliente,SexoBebe")] Cliente cliente)
        {
